...
const features = [
  ...
  },
  {
    ...
    body: "Pull your real ratings from Google Business and display them live on your landing page. No screenshots, no manual updates. Always current.",
  },
  {
    icon: "⬡",
...
const tiers = [
  ...
  },
  {
    ...
    includes: [
      ...
      "Live reviews carousel (Google Business ratings)",
      "Cloud document storage (Google Drive, Dropbox, and others)",
  ...
  },
  {
    ...
    includes: [
      ...
      "Paid ads conversion tracking (Google Ads, Meta, and others)",
