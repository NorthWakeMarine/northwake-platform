...
import { runIntegrityCheck, importQbCustomers, importQbInvoices, syncDialpadContacts, promoteDialpadLocalToCompany, pushCrmToDialpad, pushCrmToQuickBooks, syncVesselsToQbNotes } from "@/app/actions";
...
export async function GET(req: NextRequest) {
  ...
  const [qb, invoices, promote, dialpad, pushDialpad, pushQb, qbNotes, integrity] = await Promise.allSettled([
    importQbCustomers(),
    importQbInvoices(),
