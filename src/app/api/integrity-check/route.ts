...
import { runIntegrityCheck, importQbCustomers, importQbInvoices, pushCrmToQuickBooks, syncVesselsToQbNotes, importQuoContacts, pushCrmToQuo } from "@/app/actions";
...
export async function GET(req: NextRequest) {
  ...
  const [qb, invoices, pushQb, qbNotes, quo, quoPush, integrity] = await Promise.allSettled([
    importQbCustomers(),
    importQbInvoices(),
    pushCrmToQuickBooks(),
