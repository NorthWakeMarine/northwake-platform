...
export const clientConfig: ClientConfig = {
  ...
  seoTitle: "NorthWake Marine | Boat Detailing & Yacht Care, Jacksonville",
  seoDescription:
    "Jacksonville's premier marine services company. Ceramic coating, maintenance washes, Yamaha-certified engine service, and full yacht management. Free quotes.",
  seoKeywords: [
    ...
    "aircraft detailing Jacksonville FL",
    "aviation detailing Jacksonville",
    "airplane detailing Jacksonville FL",
    "aero detailing Jacksonville",
    "aircraft wash Jacksonville FL",
    "private jet detailing Jacksonville FL",
    "turboprop detailing Jacksonville",
    "hangar detailing Jacksonville",
    "RV detailing Jacksonville FL",
    "motorhome detailing Jacksonville",
    "travel trailer detailing Jacksonville FL",
    "auto detailing Jacksonville FL",
    "mobile auto detailing Jacksonville",
    "car detailing Jacksonville FL",
